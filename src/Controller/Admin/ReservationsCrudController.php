...
class ReservationsCrudController extends AbstractController
{
    ...
    public function details(ReservationRepository $reservationRepository, $date): Response
    {
    ...
    public function cancelReservation($id, ReservationRepository $reservationRepository, EntityManagerInterface $entityManagerInterface, Request $request)
    {
